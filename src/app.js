...
// import VirtualRoutes from './modules/ImageEnhancer/Routes/VirtualRoutes.js';
const VirtualRoutes = require('./modules/ImageEnhancer/Routes/VirtualRoutes.js');
...
//virtual stagging
app.use('/ai/virtual-staging', VirtualRoutes);
