...
export const AUDIT_ACTIONS = {
  ...
  CASE_SUBMITTED_TO_XOTO:    'CASE_SUBMITTED_TO_XOTO',
  CASE_PICKED_UP:            'CASE_PICKED_UP',
  CASE_ASSIGNED_TO_OPS:      'CASE_ASSIGNED_TO_OPS',
  CASE_STATUS_CHANGED:       'CASE_STATUS_CHANGED',
  CASE_RETURNED:             'CASE_RETURNED',
  CASE_RESUBMITTED:          'CASE_RESUBMITTED',
  CASE_SUBMITTED_TO_BANK:    'CASE_SUBMITTED_TO_BANK',
