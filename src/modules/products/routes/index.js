...
const { createBrand, getCategoryById, getAllBrands, getBrandByID, editBrandByID,editCategory,deleteCategoryByID, deleteBrandBYID, createCategory, getAllCategory } = require("../controllers/index.js")
const router = Router();
